...
/** Sun on the horizon — an early report. */
export function SunriseIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.25} className={className}>
      <path strokeLinecap="round" d="M3 18h18M7 18a5 5 0 0110 0M12 4v3M4.9 8.9l1.6 1.6M19.1 8.9l-1.6 1.6" />
    </svg>
  );
}
